    ...
    <div className={className}>
      ...
      <header className="relative bg-white">
        <div
          ref={Banners}
          className={` ${
            ishow ? "animate-toTop" : "animate-toBot"
          } flex h-10 items-center justify-center  bg-green-500 px-4 text-xs font-medium  text-white sm:px-6 lg:px-8`}
        >
          <p>{"<广告>"}</p>
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <a href="#">
                  ...
                  <img className="h-8 w-auto scale-150" src={logo} alt="" />
                </a>
              </div>
                      ...
                      {({ open }) => (
                        <>
                          ...
                          <Transition
                            ...
                            leaveTo="opacity-0"
                          >
                            <Popover.Panel className="absolute inset-x-0 top-full text-sm text-gray-500 z-10  bg-white">
